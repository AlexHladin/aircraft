  ...
  return (
    <div className='relative'>
      ...
      <div
        ...
        className={cn(
          'absolute right-0 top-full z-40 w-40 space-y-1 rounded-sm border border-stroke bg-white p-1.5 shadow-default',
          {
            block: dropdownOpen,
            hidden: !dropdownOpen,
          }
      ...
      >
        <button
          className='flex w-full items-center gap-2 rounded-sm py-1.5 px-4 text-left text-sm hover:bg-gray'
          onClick={() => {
            setDropdownOpen(false);
            onEdit()
          }}  
